    ...
    return knex('mentor').del()
      .then(function () {
        return knex('mentor').insert([
          ...
          {id: 9, first_name: 'Clint', last_name: 'Barton', city: 'Harlem', state: 'New York', email: 'Hawkeye', password: '$2a$08$JO1fjQc5QUkWyt1b3M7HIOzQfd13S.6oWn/ZxjFieZO5RPvb3pLve', profession: 'Long Range', image: '', description: ''},
        ]);
      });
  };
