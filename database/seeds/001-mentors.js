...
exports.seed = function(knex) {
    ...
    .then(function () {
      return knex('mentor').insert([
        ...
        {id: 4, first_name: 'Clint', last_name: 'Barton', city: 'Harlem', state: 'New York', email: 'Hawkeye@gmail.com', password: '$2a$08$mbufierGS/XnLRiSbqynCexscJQtvelJ1h5yuLxRuOHoqwPmaPh0C', profession: 'Long Range', image: '', description: ''},
      ]);
    });
  };
